...
export default function CoachCheckin() {
  ...
  function onManual(e) {
    ...
    record(manual, 'manual'); setManual('');
  }
  ...
  async function saveEarly(playerId) {
    ...
    setEarlyFor(''); setReasonNote(''); setReasonSel('Injury');
    loadRoster();
  }
  async function undoEarly(playerId) {
    await supabase.rpc('clear_left_early', { p_session_id: sessionId, p_player_id: playerId });
    loadRoster();
  }
              ...
              <div key={r.player_id} style={{ padding: '8px 10px', border: '1px solid var(--border)', borderRadius: 10 }}>
                <div className="row between" style={{ flexWrap: 'wrap', gap: 8 }}>
                  ...
                  <div className="row" style={{ gap: 6, flexWrap: 'wrap' }}>
                    {r.present
                      ? <span className="badge badge-success">✓ In {fmt(r.checkin_at)}</span>
